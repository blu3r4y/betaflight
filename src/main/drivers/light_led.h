...
#define LED0_OFF                 ledSet(0, true)
#define LED0_ON                  ledSet(0, false)

#define LED1_TOGGLE              ledToggle(1)
#define LED1_OFF                 ledSet(1, true)
#define LED1_ON                  ledSet(1, false)

#define LED2_TOGGLE              ledToggle(2)
#define LED2_OFF                 ledSet(2, true)
#define LED2_ON                  ledSet(2, false)
